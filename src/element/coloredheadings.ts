      ...
      <div class="config-group">
        <div class="config-items">
          <label class="fn__flex b3-label config-item">
            ...
            <select class="b3-select fn__flex-center fn__size200" id="neo-colored-headings-colorstyle">
              ${colorStyleOptions}
            </select>
          </label>
          <label class="fn__flex b3-label config-item">
          ...
          <label class="fn__flex b3-label config-item${fixedHueClass}" id="neo-colored-headings-initial-hue-item">
            ...
            <div class="b3-tooltips b3-tooltips__n fn__flex-center" id="neo-colored-headings-initial-hue-tooltip" aria-label="${initialHue}deg">
              <input class="b3-slider fn__size200 neo-colored-hue-slider neo-colored-hue-slider--headings" data-colorstyle="${coloredHeadingsColorStyle}" id="neo-colored-headings-initial-hue" min="0" max="360" step="1" type="range" value="${initialHue}">
            </div>
          </label>
        </div>
      </div>
...
export function showColoredHeadingsSettings(): void {
  ...
  const colorStyleSelect = dialog.element.querySelector('#neo-colored-headings-colorstyle') as HTMLSelectElement | null;
  ...
  dialog.element.querySelector('#neo-colored-headings-confirm')?.addEventListener('click', () => {
    ...
    initialHue = newHue;
    saveConfig({
      'colored-headings-colorstyle': newColorStyle,
